...
#define LOW_PRECISION`),t}function I1(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===vg?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===hS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===fa&&(t="SHADOWMAP_TYPE_VSM"),t}function H1(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ar:case Rr:t="ENVMAP_TYPE_CUBE";break;case Pc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function G1(s){let t="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===Rr&&(t="ENVMAP_MODE_REFRACTION"),t}function V1(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case _g:t="ENVMAP_BLENDING_MULTIPLY";break;case LS:t="ENVMAP_BLENDING_MIX";break;case NS:t="ENVMAP_BLENDING_ADD";break}return t}function k1(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function X1(s,t,i,r){const l=s.getContext(),u=i.defines;let d=i.vertexShader,h=i.fragmentShader;const m=I1(i),p=H1(i),_=G1(i),g=V1(i),S=k1(i),M=U1(i),T=L1(u),R=l.createProgram();let y,v,O=i.glslVersion?"#version "+i.glslVersion+`
