...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function RE(s,t,i){const r=new Float32Array(Rs),l=new re(0,1,0);return new oi({name:"SphericalGaussianBlur",defines:{n:Rs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Bc(),fragmentShader:`
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function qx(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Bc(),fragmentShader:`
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function Yx(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bc(),fragmentShader:`
	...
	`}function CE(s){let t=new WeakMap,i=null;function r(h){if(h&&h.isTexture){const m=h.mapping,p=m===Bd||m===zd,_=m===Ar||m===Rr;if(p||_){let g=t.get(h);const S=g!==void 0?g.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==S)return i===null&&(i=new Xx(s)),g=p?i.fromEquirectangular(h,g):i.fromCubemap(h,g),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),g.texture;if(g!==void 0)return g.texture;{const M=h.image;return p&&M&&M.height>0||_&&M&&l(M)?(i===null&&(i=new Xx(s)),g=p?i.fromEquirectangular(h):i.fromCubemap(h),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),h.addEventListener("dispose",u),g.texture):null}}}return h}function l(h){let m=0;const p=6;for(let _=0;_<p;_++)h[_]!==void 0&&m++;return m===p}function u(h){const m=h.target;m.removeEventListener("dispose",u);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function d(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:d}}function DE(s){const t={};function i(r){if(t[r]!==void 0)return t[r];const l=s.getExtension(r);return t[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&Fo("WebGLRenderer: "+r+" extension not supported."),l}}}function wE(s,t,i,r){const l={},u=new WeakMap;function d(g){const S=g.target;S.index!==null&&t.remove(S.index);for(const T in S.attributes)t.remove(S.attributes[T]);S.removeEventListener("dispose",d),delete l[S.id];const M=u.get(S);M&&(t.remove(M),u.delete(S)),r.releaseStatesOfGeometry(S),S.isInstancedBufferGeometry===!0&&delete S._maxInstanceCount,i.memory.geometries--}function h(g,S){return l[S.id]===!0||(S.addEventListener("dispose",d),l[S.id]=!0,i.memory.geometries++),S}function m(g){const S=g.attributes;for(const M in S)t.update(S[M],s.ARRAY_BUFFER)}function p(g){const S=[],M=g.index,T=g.attributes.position;let R=0;if(M!==null){const O=M.array;R=M.version;for(let w=0,P=O.length;w<P;w+=3){const V=O[w+0],N=O[w+1],G=O[w+2];S.push(V,N,N,G,G,V)}}else if(T!==void 0){const O=T.array;R=T.version;for(let w=0,P=O.length/3-1;w<P;w+=3){const V=w+0,N=w+1,G=w+2;S.push(V,N,N,G,G,V)}}else return;const y=new(Dg(S)?Pg:Og)(S,1);y.version=R;const v=u.get(g);v&&t.remove(v),u.set(g,y)}function _(g){const S=u.get(g);if(S){const M=g.index;M!==null&&S.version<M.version&&p(g)}else p(g);return u.get(g)}return{get:h,update:m,getWireframeAttribute:_}}function UE(s,t,i){let r;function l(S){r=S}let u,d;function h(S){u=S.type,d=S.bytesPerElement}function m(S,M){s.drawElements(r,M,u,S*d),i.update(M,r,1)}function p(S,M,T){T!==0&&(s.drawElementsInstanced(r,M,u,S*d,T),i.update(M,r,T))}function _(S,M,T){if(T===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,M,0,u,S,0,T);let y=0;for(let v=0;v<T;v++)y+=M[v];i.update(y,r,1)}function g(S,M,T,R){if(T===0)return;const y=t.get("WEBGL_multi_draw");if(y===null)for(let v=0;v<S.length;v++)p(S[v]/d,M[v],R[v]);else{y.multiDrawElementsInstancedWEBGL(r,M,0,u,S,0,R,0,T);let v=0;for(let O=0;O<T;O++)v+=M[O]*R[O];i.update(v,r,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=_,this.renderMultiDrawInstances=g}function LE(s){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(u,d,h){switch(i.calls++,d){case s.TRIANGLES:i.triangles+=h*(u/3);break;case s.LINES:i.lines+=h*(u/2);break;case s.LINE_STRIP:i.lines+=h*(u-1);break;case s.LINE_LOOP:i.lines+=h*u;break;case s.POINTS:i.points+=h*u;break;default:rn("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:r}}function NE(s,t,i){const r=new WeakMap,l=new on;function u(d,h,m){const p=d.morphTargetInfluences,_=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=_!==void 0?_.length:0;let S=r.get(h);if(S===void 0||S.count!==g){let D=function(){G.dispose(),r.delete(h),h.removeEventListener("dispose",D)};S!==void 0&&S.texture.dispose();const M=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,R=h.morphAttributes.color!==void 0,y=h.morphAttributes.position||[],v=h.morphAttributes.normal||[],O=h.morphAttributes.color||[];let w=0;M===!0&&(w=1),T===!0&&(w=2),R===!0&&(w=3);let P=h.attributes.position.count*w,V=1;P>t.maxTextureSize&&(V=Math.ceil(P/t.maxTextureSize),P=t.maxTextureSize);const N=new Float32Array(P*V*4*g),G=new wg(N,P,V,g);G.type=ha,G.needsUpdate=!0;const ne=w*4;for(let C=0;C<g;C++){const H=y[C],$=v[C],se=O[C],le=P*V*4*C;for(let ee=0;ee<H.count;ee++){const L=ee*ne;M===!0&&(l.fromBufferAttribute(H,ee),N[le+L+0]=l.x,N[le+L+1]=l.y,N[le+L+2]=l.z,N[le+L+3]=0),T===!0&&(l.fromBufferAttribute($,ee),N[le+L+4]=l.x,N[le+L+5]=l.y,N[le+L+6]=l.z,N[le+L+7]=0),R===!0&&(l.fromBufferAttribute(se,ee),N[le+L+8]=l.x,N[le+L+9]=l.y,N[le+L+10]=l.z,N[le+L+11]=se.itemSize===4?l.w:1)}}S={count:g,texture:G,size:new mt(P,V)},r.set(h,S),h.addEventListener("dispose",D)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",d.morphTexture,i);else{let M=0;for(let R=0;R<p.length;R++)M+=p[R];const T=h.morphTargetsRelative?1:1-M;m.getUniforms().setValue(s,"morphTargetBaseInfluence",T),m.getUniforms().setValue(s,"morphTargetInfluences",p)}m.getUniforms().setValue(s,"morphTargetsTexture",S.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",S.size)}return{update:u}}function OE(s,t,i,r){let l=new WeakMap;function u(m){const p=r.render.frame,_=m.geometry,g=t.get(m,_);if(l.get(g)!==p&&(t.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(i.update(m.instanceMatrix,s.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,s.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const S=m.skeleton;l.get(S)!==p&&(S.update(),l.set(S,p))}return g}function d(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:u,dispose:d}}const Vg=new Rn,Zx=new Ch(1,1),kg=new wg,Xg=new oM,Wg=new Fg,jx=[],Kx=[],Qx=new Float32Array(16),Jx=new Float32Array(9),$x=new Float32Array(4);function Nr(s,t,i){const r=s[0];if(r<=0||r>0)return s;const l=t*i;let u=jx[l];if(u===void 0&&(u=new Float32Array(l),jx[l]=u),t!==0){r.toArray(u,0);for(let d=1,h=0;d!==t;++d)h+=i,s[d].toArray(u,h)}return u}function vn(s,t){if(s.length!==t.length)return!1;for(let i=0,r=s.length;i<r;i++)if(s[i]!==t[i])return!1;return!0}function _n(s,t){for(let i=0,r=t.length;i<r;i++)s[i]=t[i]}function zc(s,t){let i=Kx[t];i===void 0&&(i=new Int32Array(t),Kx[t]=i);for(let r=0;r!==t;++r)i[r]=s.allocateTextureUnit();return i}function PE(s,t){const i=this.cache;i[0]!==t&&(s.uniform1f(this.addr,t),i[0]=t)}function BE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;s.uniform2fv(this.addr,t),_n(i,t)}}function zE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(vn(i,t))return;s.uniform3fv(this.addr,t),_n(i,t)}}function FE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;s.uniform4fv(this.addr,t),_n(i,t)}}function IE(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(vn(i,t))return;s.uniformMatrix2fv(this.addr,!1,t),_n(i,t)}else{if(vn(i,r))return;$x.set(r),s.uniformMatrix2fv(this.addr,!1,$x),_n(i,r)}}function HE(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(vn(i,t))return;s.uniformMatrix3fv(this.addr,!1,t),_n(i,t)}else{if(vn(i,r))return;Jx.set(r),s.uniformMatrix3fv(this.addr,!1,Jx),_n(i,r)}}function GE(s,t){const i=this.cache,r=t.elements;if(r===void 0){if(vn(i,t))return;s.uniformMatrix4fv(this.addr,!1,t),_n(i,t)}else{if(vn(i,r))return;Qx.set(r),s.uniformMatrix4fv(this.addr,!1,Qx),_n(i,r)}}function VE(s,t){const i=this.cache;i[0]!==t&&(s.uniform1i(this.addr,t),i[0]=t)}function kE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;s.uniform2iv(this.addr,t),_n(i,t)}}function XE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(vn(i,t))return;s.uniform3iv(this.addr,t),_n(i,t)}}function WE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;s.uniform4iv(this.addr,t),_n(i,t)}}function qE(s,t){const i=this.cache;i[0]!==t&&(s.uniform1ui(this.addr,t),i[0]=t)}function YE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;s.uniform2uiv(this.addr,t),_n(i,t)}}function ZE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(vn(i,t))return;s.uniform3uiv(this.addr,t),_n(i,t)}}function jE(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;s.uniform4uiv(this.addr,t),_n(i,t)}}function KE(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l);let u;this.type===s.SAMPLER_2D_SHADOW?(Zx.compareFunction=Cg,u=Zx):u=Vg,i.setTexture2D(t||u,l)}function QE(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture3D(t||Xg,l)}function JE(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTextureCube(t||Wg,l)}function $E(s,t,i){const r=this.cache,l=i.allocateTextureUnit();r[0]!==l&&(s.uniform1i(this.addr,l),r[0]=l),i.setTexture2DArray(t||kg,l)}function e3(s){switch(s){case 5126:return PE;case 35664:return BE;case 35665:return zE;case 35666:return FE;case 35674:return IE;case 35675:return HE;case 35676:return GE;case 5124:case 35670:return VE;case 35667:case 35671:return kE;case 35668:case 35672:return XE;case 35669:case 35673:return WE;case 5125:return qE;case 36294:return YE;case 36295:return ZE;case 36296:return jE;case 35678:case 36198:case 36298:case 36306:case 35682:return KE;case 35679:case 36299:case 36307:return QE;case 35680:case 36300:case 36308:case 36293:return JE;case 36289:case 36303:case 36311:case 36292:return $E}}function t3(s,t){s.uniform1fv(this.addr,t)}function n3(s,t){const i=Nr(t,this.size,2);s.uniform2fv(this.addr,i)}function i3(s,t){const i=Nr(t,this.size,3);s.uniform3fv(this.addr,i)}function a3(s,t){const i=Nr(t,this.size,4);s.uniform4fv(this.addr,i)}function s3(s,t){const i=Nr(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function r3(s,t){const i=Nr(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function o3(s,t){const i=Nr(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function l3(s,t){s.uniform1iv(this.addr,t)}function c3(s,t){s.uniform2iv(this.addr,t)}function u3(s,t){s.uniform3iv(this.addr,t)}function f3(s,t){s.uniform4iv(this.addr,t)}function d3(s,t){s.uniform1uiv(this.addr,t)}function h3(s,t){s.uniform2uiv(this.addr,t)}function p3(s,t){s.uniform3uiv(this.addr,t)}function m3(s,t){s.uniform4uiv(this.addr,t)}function x3(s,t,i){const r=this.cache,l=t.length,u=zc(i,l);vn(r,u)||(s.uniform1iv(this.addr,u),_n(r,u));for(let d=0;d!==l;++d)i.setTexture2D(t[d]||Vg,u[d])}function g3(s,t,i){const r=this.cache,l=t.length,u=zc(i,l);vn(r,u)||(s.uniform1iv(this.addr,u),_n(r,u));for(let d=0;d!==l;++d)i.setTexture3D(t[d]||Xg,u[d])}function v3(s,t,i){const r=this.cache,l=t.length,u=zc(i,l);vn(r,u)||(s.uniform1iv(this.addr,u),_n(r,u));for(let d=0;d!==l;++d)i.setTextureCube(t[d]||Wg,u[d])}function _3(s,t,i){const r=this.cache,l=t.length,u=zc(i,l);vn(r,u)||(s.uniform1iv(this.addr,u),_n(r,u));for(let d=0;d!==l;++d)i.setTexture2DArray(t[d]||kg,u[d])}function S3(s){switch(s){case 5126:return t3;case 35664:return n3;case 35665:return i3;case 35666:return a3;case 35674:return s3;case 35675:return r3;case 35676:return o3;case 5124:case 35670:return l3;case 35667:case 35671:return c3;case 35668:case 35672:return u3;case 35669:case 35673:return f3;case 5125:return d3;case 36294:return h3;case 36295:return p3;case 36296:return m3;case 35678:case 36198:case 36298:case 36306:case 35682:return x3;case 35679:case 36299:case 36307:return g3;case 35680:case 36300:case 36308:case 36293:return v3;case 36289:case 36303:case 36311:case 36292:return _3}}class M3{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.setValue=e3(i.type)}}class y3{constructor(t,i,r){this.id=t,this.addr=r,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=S3(i.type)}}class b3{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,r){const l=this.seq;for(let u=0,d=l.length;u!==d;++u){const h=l[u];h.setValue(t,i[h.id],r)}}}const Ed=/(\w+)(\])?(\[|\.)?/g;function eg(s,t){s.seq.push(t),s.map[t.id]=t}function E3(s,t,i){const r=s.name,l=r.length;for(Ed.lastIndex=0;;){const u=Ed.exec(r),d=Ed.lastIndex;let h=u[1];const m=u[2]==="]",p=u[3];if(m&&(h=h|0),p===void 0||p==="["&&d+2===l){eg(i,p===void 0?new M3(h,s,t):new y3(h,s,t));break}else{let g=i.map[h];g===void 0&&(g=new b3(h),eg(i,g)),i=g}}}class Dc{constructor(t,i){this.seq=[],this.map={};const r=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<r;++l){const u=t.getActiveUniform(i,l),d=t.getUniformLocation(i,u.name);E3(u,d,this)}}setValue(t,i,r,l){const u=this.map[i];u!==void 0&&u.setValue(t,r,l)}setOptional(t,i,r){const l=i[r];l!==void 0&&this.setValue(t,r,l)}static upload(t,i,r,l){for(let u=0,d=i.length;u!==d;++u){const h=i[u],m=r[h.id];m.needsUpdate!==!1&&h.setValue(t,m.value,l)}}static seqWithValue(t,i){const r=[];for(let l=0,u=t.length;l!==u;++l){const d=t[l];d.id in i&&r.push(d)}return r}}function tg(s,t,i){const r=s.createShader(t);return s.shaderSource(r,i),s.compileShader(r),r}const T3=37297;let A3=0;function R3(s,t){const i=s.split(`
`),r=[],l=Math.max(t-6,0),u=Math.min(t+6,i.length);for(let d=l;d<u;d++){const h=d+1;r.push(`${h===t?">":" "} ${h}: ${i[d]}`)}return r.join(`
`)}const ng=new ft;function C3(s){Ut._getMatrix(ng,Ut.workingColorSpace,s);const t=`mat3( ${ng.elements.map(i=>i.toFixed(4))} )`;switch(Ut.getTransfer(s)){case Uc:return[t,"LinearTransferOETF"];case kt:return[t,"sRGBTransferOETF"];default:return lt("WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function ig(s,t,i){const r=s.getShaderParameter(t,s.COMPILE_STATUS),u=(s.getShaderInfoLog(t)||"").trim();if(r&&u==="")return"";const d=/ERROR: 0:(\d+)/.exec(u);if(d){const h=parseInt(d[1]);return i.toUpperCase()+`

`+u+`

`+R3(s.getShaderSource(t),h)}else return u}function D3(s,t){const i=C3(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function w3(s,t){let i;switch(t){case PS:i="Linear";break;case BS:i="Reinhard";break;case zS:i="Cineon";break;case FS:i="ACESFilmic";break;case HS:i="AgX";break;case GS:i="Neutral";break;case IS:i="Custom";break;default:lt("WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ec=new re;function U3(){Ut.getLuminanceCoefficients(Ec);const s=Ec.x.toFixed(4),t=Ec.y.toFixed(4),i=Ec.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function L3(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Po).join(`
`)}function N3(s){const t=[];for(const i in s){const r=s[i];r!==!1&&t.push("#define "+i+" "+r)}return t.join(`
`)}function O3(s,t){const i={},r=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const u=s.getActiveAttrib(t,l),d=u.name;let h=1;u.type===s.FLOAT_MAT2&&(h=2),u.type===s.FLOAT_MAT3&&(h=3),u.type===s.FLOAT_MAT4&&(h=4),i[d]={type:u.type,location:s.getAttribLocation(t,d),locationSize:h}}return i}function Po(s){return s!==""}function ag(s,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function sg(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const P3=/^[ \t]*#include +<([\w\d./]+)>/gm;function gh(s){return s.replace(P3,z3)}const B3=new Map;function z3(s,t){let i=ht[t];if(i===void 0){const r=B3.get(t);if(r!==void 0)i=ht[r],lt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,r);else throw new Error("Can not resolve #include <"+t+">")}return gh(i)}const F3=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function rg(s){return s.replace(F3,I3)}function I3(s,t,i,r){let l="";for(let u=parseInt(t);u<parseInt(i);u++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+u+" ]").replace(/UNROLLED_LOOP_INDEX/g,u);return l}function og(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function H3(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===vg?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===pS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===fa&&(t="SHADOWMAP_TYPE_VSM"),t}function G3(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ar:case Rr:t="ENVMAP_TYPE_CUBE";break;case Pc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function V3(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Rr:t="ENVMAP_MODE_REFRACTION";break}return t}function k3(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case _g:t="ENVMAP_BLENDING_MULTIPLY";break;case NS:t="ENVMAP_BLENDING_MIX";break;case OS:t="ENVMAP_BLENDING_ADD";break}return t}function X3(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function W3(s,t,i,r){const l=s.getContext(),u=i.defines;let d=i.vertexShader,h=i.fragmentShader;const m=H3(i),p=G3(i),_=V3(i),g=k3(i),S=X3(i),M=L3(i),T=N3(u),R=l.createProgram();let y,v,O=i.glslVersion?"#version "+i.glslVersion+`
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(s)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(s,t=Ho){this.fullscreenMaterial.depthBuffer=s,this.fullscreenMaterial.depthPacking=t;for(const i of this.effects)i.setDepthTexture(s,t)}render(s,t,i,r,l){for(const u of this.effects)u.update(s,t,r);if(!this.skipRendering||this.renderToScreen){const u=this.fullscreenMaterial;u.inputBuffer=t.texture,u.time+=r*this.timeScale,s.setRenderTarget(this.renderToScreen?null:i),s.render(this.scene,this.camera)}}setSize(s,t){this.fullscreenMaterial.setSize(s,t);for(const i of this.effects)i.setSize(s,t)}initialize(s,t,i){this.renderer=s;for(const r of this.effects)r.initialize(s,t,i);this.updateMaterial(),i!==void 0&&i!==ri&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const s of this.effects)s.removeEventListener("change",this.listener),s.dispose()}handleEvent(s){switch(s.type){case"change":this.recompile();break}}};const mT=()=>{const t=document.createElement("canvas");t.width=64,t.height=64;const i=t.getContext("2d");if(!i)throw new Error("2D context not available");i.fillStyle="black",i.fillRect(0,0,t.width,t.height);const r=new Rn(t);r.minFilter=An,r.magFilter=An,r.generateMipmaps=!1;const l=[];let u=null;const d=64;let h=.1*64;const m=1/d,p=()=>{i.fillStyle="black",i.fillRect(0,0,t.width,t.height)},_=M=>{const T={x:M.x*64,y:(1-M.y)*64};let R=1;const y=P=>Math.sin(P*Math.PI/2),v=P=>-P*(P-2);M.age<d*.3?R=y(M.age/(d*.3)):R=v(1-(M.age-d*.3)/(d*.7))||0,R*=M.force;const O=`${(M.vx+1)/2*255}, ${(M.vy+1)/2*255}, ${R*255}`,w=320;i.shadowOffsetX=w,i.shadowOffsetY=w,i.shadowBlur=h,i.shadowColor=`rgba(${O},${.22*R})`,i.beginPath(),i.fillStyle="rgba(255,0,0,1)",i.arc(T.x-w,T.y-w,h,0,Math.PI*2),i.fill()};return{canvas:t,texture:r,addTouch:M=>{let T=0,R=0,y=0;if(u){const v=M.x-u.x,O=M.y-u.y;if(v===0&&O===0)return;const w=v*v+O*O,P=Math.sqrt(w);R=v/(P||1),y=O/(P||1),T=Math.min(w*1e4,1)}u={x:M.x,y:M.y},l.push({x:M.x,y:M.y,age:0,force:T,vx:R,vy:y})},update:()=>{p();for(let M=l.length-1;M>=0;M--){const T=l[M],R=T.force*m*(1-T.age/d);T.x+=T.vx*R,T.y+=T.vy*R,T.age++,T.age>d&&l.splice(M,1)}for(let M=0;M<l.length;M++)_(l[M]);r.needsUpdate=!0},set radiusScale(M){h=.1*64*M},get radiusScale(){return h/(.1*64)},size:64}},xT=(s,t)=>{const i=`
    ...
    `;return new Yg("LiquidEffect",i,{uniforms:new Map([["uTexture",new an(s)],["uStrength",new an(t?.strength??.025)],["uTime",new an(0)],["uFreq",new an(t?.freq??4.5)]])})},gg={square:0,circle:1,triangle:2,diamond:3},gT=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,vT=`
