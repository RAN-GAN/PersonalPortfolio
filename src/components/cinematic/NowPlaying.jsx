...
function NowPlaying() {
  ...
  return (
    ...
    >
      <div
        className="relative w-full overflow-hidden rounded-[12px] transition-all duration-300 hover:-translate-y-0.5"
        style={{
          minHeight: "80px",
          background: "rgba(255,255,255,0.07)",
          backdropFilter: "blur(10px) saturate(1.5) brightness(1.04)",
          WebkitBackdropFilter: "blur(10px) saturate(1.5) brightness(1.04)",
          border: "1px solid rgba(255,255,255,0.16)",
          boxShadow: "0 2px 14px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.12)",
        }}
      >
        ...
        {/* specular top-edge — preserves the glass depth feel */}
        <div
        ...
        {/* ── Content ── */}
        <div
          className="relative z-10 flex flex-col justify-between p-3"
            ...
            >
              ...
              <p
                style={{
                  ...
                  overflow: "hidden",
                  textOverflow: "ellipsis",
                  textShadow: "0 1px 3px rgba(0,0,0,0.95), 0 2px 8px rgba(0,0,0,0.7)",
                }}
              >
